...
> [例1.03]  查询学生的学号和姓名。 关系运算表示为：$\Pi_{Sno,Sname}(Student)$，运算结果如图1-6-4(a)所示 。<br>
...
> [例1.05] 查询学生和该学生的选课信息。 等值连接表示为：$Student \Join_{Student.Sno=SC.Sno} SC$，运算结果如图1-6-5(a)所示 。<br>
...
> [例1.07] 关系$R$和关系$S$的外连接，表示为：$SR ⟗S$，运算结果如图1-6-6(b)所示 。<br>
> [例1.08] 关系$R$和关系$S$的左外连接，表示为：$R ⟕ S$，运算结果如图1-6-6(c)所示。<br>
...
[**上一页<<**](../common/chapter1.05.md) | [**>>下一页**](chapter1.07-R.md)
