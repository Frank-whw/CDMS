...
**1**. 请对5.02节第1题（电影网站）构建相应的文档数据库模式，然后再根据应用访问数据库的方式对模式进行优化。

**2**. 请对5.02节第2题（床位分享平台）构建相应的文档数据库模式，然后再根据应用访问数据库的方式对模式进行优化。

**2**. 请对5.05节第3题（校园学术活动网站）构建相应的文档数据库模式，然后再根据应用访问数据库的方式对模式进行优化。

[**上一页<<**](chapter5.06-D.md) | [**>>下一页**](chapter5.08-G.md)
